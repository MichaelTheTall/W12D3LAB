...
public class Motorcycle extends Vehicle implements IFuel, IPaint, IRun {
    Engine engine;
    Tank tank;

    public Motorcycle(int numOfDoors, int numOfWheels, Colour colour, double price, Engine engine, Tank tank) {
