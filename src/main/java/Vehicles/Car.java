...
public class Car extends Vehicle implements IFuel, IPaint, IRun {
    Engine engine;
    Tank tank;

    public Car(int numOfDoors, int numOfWheels, Colour colour, double price, Engine engine, Tank tank) {
